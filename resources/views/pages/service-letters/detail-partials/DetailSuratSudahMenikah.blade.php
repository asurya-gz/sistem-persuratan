{{-- resources/views/user/surat/DetailSudahMenikah.blade.php --}}

<div class="alert alert-info d-flex align-items-center" role="alert">
    <i class="fas fa-info-circle me-2 fa-lg"></i>
    <div>
        <strong>Informasi:</strong> Data detail Surat Keterangan Sudah Menikah ditampilkan di bawah ini.
    </div>
</div>
        ...
        <table class="table table-bordered table-striped align-middle">
            <tbody>
                ...
                <tr class="table-secondary">
                    <th colspan="2" class="text-center">Data Suami</th>
                </tr>
                <tr>
                    <th style="width: 250px;">Nama Pria</th>
                ...
                {{-- Data Wanita --}}
                <tr class="table-secondary">
                    <th colspan="2" class="text-center">Data Istri</th>
                </tr>
                <tr>
                    <th>Nama Wanita</th>
                ...
                <tr class="table-secondary">
                    <th colspan="2" class="text-center">Informasi Pernikahan</th>
                </tr>
                <tr>
...
@else
    <div class="alert alert-warning d-flex align-items-center mt-4" role="alert">
        ...
        <div>
            <strong>Data Sudah Menikah belum tersedia.</strong> Silakan lengkapi formulir terlebih dahulu.
        </div>
    </div>
@endif
