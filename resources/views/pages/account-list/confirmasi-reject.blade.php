      ...
      <div class="modal-content shadow-lg rounded-4 border-0 animate__animated animate__fadeInDown">
        <div class="modal-header bg-danger text-white rounded-top-4">
          <h5 class="modal-title" id="confirmasirejectLabel">
            <i class="fas fa-times-circle me-2"></i> Konfirmasi Non-Aktifkan Akun
          </h5>
        ...
        <div class="modal-body">
          ...
          <p class="mb-0 fs-6">Apakah Anda yakin ingin <strong>Non-Aktifkan</strong> akun ini?</p>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-danger shadow-sm">
            <i class="fas fa-times-circle me-1"></i> Ya, Non-Aktifkan
          </button>
        </div>
      </div>
    </form>
